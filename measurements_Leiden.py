...
station.keithley1.integrationtime(.01)
...
Bsweep = Sweep(sweep_params=d.field, plot_params=[d.Rsq, d.I_AC, d.V_AC])
...
#%% Run sweep
Vgsweep.run([d.Vg(),-3000,10], task_list=[break_at_leakage], cw=1)
