...
#        'B_real'#,'sample_resistance'
    ...
    def __init__(self, name, 
        ...
        parameter_map = {
        'positive_mux_voltage': {'instrument': U2_instr_name,'parameter': 'dac8'},
        'negative_mux_voltage': {'instrument': U2_instr_name,'parameter': 'dac7'},
        'positive_shiftregister_voltage': {'instrument': U2_instr_name,'parameter': 'dac4'},
        'negative_shiftregister_voltage': {'instrument': U2_instr_name,'parameter': 'dac3'},
        'positive_mux_voltage_span': {'instrument': U2_instr_name,'parameter': 'span8'},
        'negative_mux_voltage_span': {'instrument': U2_instr_name,'parameter': 'span7'},
        'positive_shiftregister_voltage_span': {'instrument': U2_instr_name,'parameter': 'span4'},
        'negative_shiftregister_voltage_span': {'instrument': U2_instr_name,'parameter': 'span3'},
        'logic_high': {'instrument': U2_instr_name, 'parameter': 'dac6'},
        'logic_low': {'instrument': U2_instr_name, 'parameter': 'dac5'},
        'logic_high_span': {'instrument': U2_instr_name, 'parameter': 'span6'},
        'logic_low_span': {'instrument': U2_instr_name, 'parameter': 'span5'},
    }
        ...
        voltage_spans = {
            'positive_mux_voltage_span': FOUR_VOLTS_UNI, #increase range of +Vsupply dac output for power
            'negative_mux_voltage_span': FOUR_VOLTS_BI,
            'positive_shiftregister_voltage_span': FOUR_VOLTS_BI,
            'negative_shiftregister_voltage_span': FOUR_VOLTS_BI,
            'logic_high_span': FOUR_VOLTS_BI,
            'logic_low_span': FOUR_VOLTS_BI
            }
        ...
        '''
        self.testd5a = self.find_instrument(U2_instr_name)
...
#            sleep(0.2)
    ...
    def set_voltages_U2_minimum(self):
        self.set_voltages_U2_centered_at(-1.4)
        
    def set_voltages_U2_maximum(self):
        self.set_voltages_U2_centered_at(1.4)
        
    def set_voltages_U2_centered_at(self, voltage_center):
        self.set_voltages_U2(self._generate_voltages_map(voltage_center))
        
    def _generate_voltages_map(self, voltage_center):
        if voltage_center > 1.4 or voltage_center < -1.4:
            raise ValueError('voltage_center out of range, should be -1.4 < v < 1.4')
            
        return { 'positive_mux_voltage': voltage_center + 2.5,
                 'negative_mux_voltage': voltage_center - 2.5,
                 'positive_shiftregister_voltage': voltage_center + 2.5,
                 'negative_shiftregister_voltage': voltage_center - 2.5,
                 'logic_high': voltage_center + 2.5,
                 'logic_low': voltage_center - 2.5 }
