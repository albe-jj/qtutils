# -*- coding: utf-8 -*-
"""
Created on Mon Oct 22 10:39:06 2018

@author: Brian Paquelet Wuetz
"""
...
class U2_moduleQC(Instrument):
    """
    Qcodes driver for the U2 croymux control SPI-rack module.
    ...
    def __init__(self, name, spi_rack, module, inter_delay=0.1, dac_step=10e-3,
        ...
        self.d5a = U2_module(spi_rack, module, reset_voltages=reset_voltages)#, num_dacs=number_dacs)
        self._mV = mV
    ...
    def _get_validator(self, dac):
        ...
        if span == U2_module.range_2V_bi:
            validator = Numbers(-2 * self._gain, 2 * self._gain)
        elif span == U2_module.range_4V_bi:
            validator = Numbers(-4 * self._gain, 4 * self._gain)
        elif span == U2_module.range_4V_uni:
