...
class DevConfig:
    ...
    Vxymeasure_gain_AC = 1e3 * 1  #V/V
    # Vmeasure_gain_DC = 1e3 * 1 #V/V

    Vsource_gain = 100e-3 #V/V
    ...
    dev_params =  { 
        ...
        'Vxy_AC': {'instrument': 'lia2','parameter': 'X', 
        ...
        'I_leak': {'instrument': 'keithley1', 'parameter':  
